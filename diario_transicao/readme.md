...
- Definir e controlar o ciclo hormonal

- Calcular automaticamente a próxima aplicação

- Registrar diariamente o nível de disforia

- Visualizar a evolução da disforia em gráfico
...
- Salvamento automático do ciclo escolhido

- Aplicação de Hormônio

- Registro da data da última aplicação
